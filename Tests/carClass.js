...
var Porshe = require('../Apps/carClass.js');
  describe("Car Class: Create a car, make it drive", function() {
    ...
    it("The car should have four (4) doors except its a Porshe or Koenigsegg", function() {
    ...
    it("The car should have four (4) wheels except its a type of trailer", function() {
    ...
    it("The car drive function should return the instance of the Car class", function() {
      var man  = new Car('MAN', 'Truck', 'trailer');
      var drivingMan = console.log(man.drive(7));
